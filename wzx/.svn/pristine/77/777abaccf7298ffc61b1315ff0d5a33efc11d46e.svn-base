...
public class Encodes {
	 ...
	 */
	/*
	 * public static String urlEncode(String part) { try { return
	 * URLEncoder.encode(part, DEFAULT_URL_ENCODING); } catch
	 * (UnsupportedEncodingException e) { throw Exceptions.unchecked(e); } }
	 */
	 ...
	 * 
	 * try { return URLDecoder.decode(part, DEFAULT_URL_ENCODING); } catch
	 * (UnsupportedEncodingException e) { throw Exceptions.unchecked(e); } }
	 */
	public static String encrypt(String sPassword, String sKey)
			throws Exception {
		return getMD5(sPassword);
	}
}
